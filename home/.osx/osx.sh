...
sudo scutil --set ComputerName "peewee"
sudo scutil --set HostName "peewee"
sudo scutil --set LocalHostName "peewee"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "peewee"
...
# Set dock size
defaults write com.apple.dock tilesize -integer 14
